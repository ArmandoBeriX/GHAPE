                ...
                for dia in range(1, 6):
                    ...
                    if local_id:
                        ...
                        if local_ocupado:
                            ...
                            errores_por_celda.setdefault(grupo_id, {}).setdefault(clase, {})[dia] = f'Local {local} ya ocupado'
